...
// //ssbo
// offset expects a 16 byte offset between elements, 
// so even tho vec3 is all we need, use vec4
...
void main()
{
    ...
    vec3 vertexPosition_worldspace = matrix[gl_InstanceID + gl_BaseInstance].xyz
    ...
    out_id          = gl_InstanceID + gl_BaseInstance;
};